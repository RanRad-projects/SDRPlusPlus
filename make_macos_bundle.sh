...
bundle_install_binary $BUNDLE $BUNDLE/Contents/Plugins $BUILD_DIR/source_modules/raw_file_source/raw_file_source.dylib
...
bundle_install_binary $BUNDLE $BUNDLE/Contents/Plugins $BUILD_DIR/decoder_modules/satv_decoder/satv_decoder.dylib
...
bundle_install_binary $BUNDLE $BUNDLE/Contents/Plugins $BUILD_DIR/misc_modules/signalstrengthgraph/signalstrengthgraph.dylib
