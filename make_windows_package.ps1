...
cp $build_dir/source_modules/raw_file_source/Release/raw_file_source.dll sdrpp_windows_x64/modules/
...
cp $build_dir/decoder_modules/satv_decoder/Release/satv_decoder.dll sdrpp_windows_x64/modules/
...
cp $build_dir/misc_modules/signalstrengthgraph/Release/signalstrengthgraph.dll sdrpp_windows_x64/modules/
